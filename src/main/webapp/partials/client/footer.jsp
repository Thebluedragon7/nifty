...
<footer class="text-center" style="box-shadow: 2px 0px 11px;">
	<div class="container text-muted py-4 py-lg-5">
		...
		<p class="mb-0">Copyright © 2023 Nifty</p>
	</div>
</footer>
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-footer">
				...
				<button class="btn btn-outline-primary outline" type="button">Yes</button>
			</div>
		</div>
	</div>
</div>
